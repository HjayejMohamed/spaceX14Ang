...
export type GetCapsulesQuery = { __typename?: 'Query', capsules?: Array<{ __typename?: 'Capsule', id?: string , landings?: number , original_launch?: any , reuse_count?: number , status?: string , type?: string , missions?: Array<{ __typename?: 'CapsuleMission', flight?: number , name?: string  } >  } >  };

export type GetCapsulesPageQueryVariables = Exact<{
  offset: Scalars['Int'];
  limit: Scalars['Int'];
}>;


export type GetCapsulesPageQuery = { __typename?: 'Query', capsules?: Array<{ __typename?: 'Capsule', id?: string , landings?: number , original_launch?: any , reuse_count?: number , status?: string , type?: string , missions?: Array<{ __typename?: 'CapsuleMission', flight?: number , name?: string  } >  } >  };

export type GetLunchesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetLunchesQuery = { __typename?: 'Query', launches?: Array<{ __typename?: 'Launch', details?: string , id?: string , is_tentative?: boolean , launch_date_local?: any , mission_name?: string , upcoming?: boolean , launch_site?: { __typename?: 'LaunchSite', site_name?: string  } , ships?: Array<{ __typename?: 'Ship', id?: string , name?: string  } >  } >  };

export type GetMissionsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetMissionsQuery = { __typename?: 'Query', missions?: Array<{ __typename?: 'Mission', id?: string , manufacturers?: Array<string > , name?: string , twitter?: string , website?: string , description?: string  } >  };

export type GetShipsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetShipsQuery = { __typename?: 'Query', ships?: Array<{ __typename?: 'Ship', class?: number , id?: string , model?: string , name?: string , speed_kn?: number , status?: string , missions?: Array<{ __typename?: 'ShipMission', flight?: string , name?: string  } >  } >  };
...
export const GetCapsulesDocument = gql`
  ...
  export class GetCapsulesGQL extends Apollo.Query<GetCapsulesQuery, GetCapsulesQueryVariables> {
    override document = GetCapsulesDocument;
    
    constructor(apollo: Apollo.Apollo) {
      super(apollo);
    }
  }
export const GetCapsulesPageDocument = gql`
  ...
  export class GetCapsulesPageGQL extends Apollo.Query<GetCapsulesPageQuery, GetCapsulesPageQueryVariables> {
    override document = GetCapsulesPageDocument;
    
    constructor(apollo: Apollo.Apollo) {
      super(apollo);
    }
  }
export const GetLunchesDocument = gql`
    query getLunches {
  launches {
    details
    id
  ...
  export class GetLunchesGQL extends Apollo.Query<GetLunchesQuery, GetLunchesQueryVariables> {
    override document = GetLunchesDocument;
...
export const GetMissionsDocument = gql`
  ...
  export class GetMissionsGQL extends Apollo.Query<GetMissionsQuery, GetMissionsQueryVariables> {
    override document = GetMissionsDocument;
...
export const GetShipsDocument = gql`
  ...
  export class GetShipsGQL extends Apollo.Query<GetShipsQuery, GetShipsQueryVariables> {
    override document = GetShipsDocument;
